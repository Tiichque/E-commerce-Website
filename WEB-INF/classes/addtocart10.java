...
@WebServlet("/addtocart10")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class addtocart10 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      out.println("<img src='images/products/product10gold.webp' alt=''>");
      out.println("</div>");
      out.println("</div>");
      out.println("<div class='col-md-6'>");
      ...
      try (
         ...
         // Retrieve the books' id. Can order more than one books.
              ...
              String sqlStr = "INSERT INTO orders (name, colour, qty, buyer) VALUES ("
                     + "'" + "Jesus Rectangle" + "'" + "," + "'" + request.getParameter("colour") + "'" + "," + request.getParameter("qty") + ", '" + request.getParameter("buyer") + "'" + ")";
