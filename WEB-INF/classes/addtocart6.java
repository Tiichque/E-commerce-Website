...
@WebServlet("/addtocart6")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class addtocart6 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      out.println("<img src='images/products/product6black.webp' alt=''>");
      out.println("</div>");
      out.println("</div>");
      out.println("<div class='col-md-6'>");
      ...
      out.println("</div>");
      out.println("<p>");
      out.println("John Goodman Round");
      out.println("</p>");
      ...
      try (
         ...
         // Retrieve the books' id. Can order more than one books.
              ...
              String sqlStr = "INSERT INTO orders (name, colour, qty, buyer) VALUES ("
                     + "'" + "John Goodman Round" + "'" + "," + "'" + request.getParameter("colour") + "'" + "," + request.getParameter("qty") + ", '" + request.getParameter("buyer") + "'" + ")";
