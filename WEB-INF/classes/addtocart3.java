...
@WebServlet("/addtocart3")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class addtocart3 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      out.println("<img src='images/products/product3gold.webp' alt=''>");
      out.println("</div>");
      out.println("</div>");
      out.println("<div class='col-md-6'>");
      ...
      out.println("</div>");
      out.println("<p>");
      out.println("Pikotaro Frameless");
      out.println("</p>");
      ...
      try (
         ...
         // Retrieve the books' id. Can order more than one books.
              ...
              String sqlStr = "INSERT INTO orders (name, colour, qty, buyer) VALUES ("
                     + "'" + "Pikotaro Frameless" + "'" + "," + "'" + request.getParameter("colour") + "'" + "," + request.getParameter("qty") + ", '" + request.getParameter("buyer") + "'" + ")";
