...
@WebServlet("/addtocart4")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class addtocart4 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      out.println("<span>OnlyLens</span>");
      out.println("</a>");
      ...
      out.println("<img src='images/products/product4black.webp' alt=''>");
      out.println("</div>");
      out.println("</div>");
      out.println("<div class='col-md-6'>");
      ...
      out.println("</div>");
      out.println("<p>");
      out.println("Don Draper Browline");
      out.println("</p>");
      ...
      try (
         ...
         // Retrieve the books' id. Can order more than one books.
              ...
              String sqlStr = "INSERT INTO orders (name, colour, qty, buyer) VALUES ("
                     + "'" + "Don Draper Browline" + "'" + "," + "'" + request.getParameter("colour") + "'" + "," + request.getParameter("qty") + ", '" + request.getParameter("buyer") + "'" + ")";
